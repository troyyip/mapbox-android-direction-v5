...
public class DirectionsCriteria {
    ...
    /*
     * DirectionsEndpoint "typedef"
     */

    @StringDef({ENDPOINT_COM, ENDPOINT_PROXY})
    @Retention(RetentionPolicy.SOURCE)
    public @interface DirectionsEndpoint {}
    public static final String ENDPOINT_COM = "https://api.mapbox.com";
    public static final String ENDPOINT_PROXY = "https://api-global.mapbox.cn";
